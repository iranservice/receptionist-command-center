...
export const Route = createFileRoute("/app/$tenant/members")({
  component: () => (
    <>
      ...
      <Placeholder scope="Level B" title="Tenant members" notes={["Invites, role assignments, team groupings within the tenant."]} contract="Authorization truth lives in the backend." />
    </>
  ),
});
